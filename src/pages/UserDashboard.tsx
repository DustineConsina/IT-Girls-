...
const UserDashboard: FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Welcome to Your Dashboard</h1>
          <p className="text-xl text-slate-300">Explore our latest collections and amazing deals</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition">
            <h3 className="text-slate-600 text-sm font-semibold uppercase mb-2">Total Products</h3>
            <p className="text-4xl font-bold text-slate-900">{products.length}</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition">
            <h3 className="text-slate-600 text-sm font-semibold uppercase mb-2">Cart Items</h3>
            <p className="text-4xl font-bold text-slate-900">{cart.length}</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition">
            <h3 className="text-slate-600 text-sm font-semibold uppercase mb-2">Favorites</h3>
            <p className="text-4xl font-bold text-slate-900">{favorites.length}</p>
          </div>
        </div>
